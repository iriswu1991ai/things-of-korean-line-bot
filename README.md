...
- 核心題庫共 180 個不重複文法表達，TOPIK 1–6 級各 30 個。
- 每天推播 2 個，連續 90 天不重複，第 91 天才重新循環。
- TOPIK 官方沒有公布唯一的 1–6 級完整文法表；本專案依表達複雜度、接續方式與常見學習階段推估級別。
- 固定題庫決定每天的文法項目；Cloudflare Workers AI 只補上接續規則、繁中說明及兩組韓中例句，不會自行更換題目。
